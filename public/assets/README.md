...
| `skin-medieval/` | **SKIN ACTIF** — sprites du monde (gobelin, orc, brute, chauve-souris, chevalier, 3 tours, Bastion, dalle) | **projet Bastion** | **maison** — aucun crédit tiers | dessinés pour le projet (ADR-016) |
