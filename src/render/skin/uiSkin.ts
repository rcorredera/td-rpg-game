// ============================================================
// render/skin/uiSkin.ts — Chrome d'UI composé depuis le pack Tiny Swords (CC0).
//
...
import { cropBuffer, opaqueBBox, remapBufferByLuma } from "../assets/colorRemap";
import type { PixelBox } from "../assets/colorRemap";
