// ============================================================
// render/assets/backdrop.ts — Fonds d'écran générés sur canvas (ADR-014).
//
...
// au boot — même technique que les curseurs (render/theme/ui.ts) : nettes à toute
...
import { UI_THEME } from "../theme/uiTheme";
